class Complex {
     ...
     */
    static multiply = function multiply(a: Complex, b: Complex): Complex {
     ...
     */
    static add = function add(a: Complex, b: Complex): Complex {
        return new Complex(a.re + b.re, a.im + b.im);
    }
     ...
     */
    static divideNCompl = function divideNCompl(n: number, c: Complex): Complex {
     ...
     */
    static root = function root(c: Complex, n: number): Complex[] {
        const a = c.re;
        const b = c.im;
     ...
     */
    static cubicRoot = function cubicRoot(c: Complex): Complex {
        const a = c.re;
        const b = c.im;
